            ...
            <section style={styles.main}>
                <div style={styles.form}>
                    ...
                    <form style={styles.div}  action="processa_upload.php" method="post" encType="multipart/form-data">
                            ...
                            <FormControl variant="filled">
                                <InputLabel htmlFor="component-filled">Confirme a senha</InputLabel>
                                <FilledInput style={styles.texto} id="component-filled"/>
                            </FormControl> 
                    ...
                    <Link href="" passHref><Button style={styles.buttonRegistrar} variant="contained" fullWidth >Registrar</Button></Link>
                </div>
